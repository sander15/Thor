...
PROJECT_NAME       ?= Sander-Game
RAYLIB_VERSION     ?= 4.0.0
RAYLIB_API_VERSION ?= 4.0.0
RAYLIB_PATH        ?= C:\raylib-4.0.0
...
CFLAGS += -Wall -std=c++98 -D_DEFAULT_SOURCE -Wno-missing-braces
...
PROJECT_SOURCE_FILES ?= main.cpp player.cpp platform.cpp
